...
public abstract class TestSuiteAdapter<A extends GeneticAlgorithm<TestChromosome>>
    ...
    public void setCrossOverFunction(CrossOverFunction<TestSuiteChromosome> crossover)
        ...
        if (algorithm != null) {
            ...
            } else if (crossover instanceof org.evosuite.ga.operators.crossover.MiddleCrossOver) {
                algorithm.setCrossOverFunction(new org.evosuite.ga.operators.crossover.MiddleCrossOver<>());
            } else {
